var WAMap = (function () {
  ...
  function constructLegend(map) {
    ...
    container.appendChild(document.createElement('br'));
    container.appendChild(generateSvgImage(settings.shapes.kioki, settings.colors.altitude.high, ShadeRgb(settings.colors.altitude.high)));
    container.appendChild(document.createTextNode('High'));
    container.appendChild(document.createElement('br'));
    container.appendChild(generateSvgImage(settings.shapes.kioki, settings.colors.altitude.medium, ShadeRgb(settings.colors.altitude.medium)));
    container.appendChild(document.createTextNode('Medium'));
    container.appendChild(document.createElement('br'));
    container.appendChild(generateSvgImage(settings.shapes.kioki, settings.colors.altitude.low, ShadeRgb(settings.colors.altitude.low)));
    ...
    container.appendChild(document.createElement('br'));
    container.appendChild(generateSvgImage(settings.shapes.kioki, settings.colors.islands[2], ShadeRgb(settings.colors.islands[2])));
    container.appendChild(document.createTextNode('Expanse'));
    container.appendChild(document.createElement('br'));
    container.appendChild(generateSvgImage(settings.shapes.kioki, settings.colors.islands[3], ShadeRgb(settings.colors.islands[3])));
    container.appendChild(document.createTextNode('Remnants'));
    container.appendChild(document.createElement('br'));
    container.appendChild(generateSvgImage(settings.shapes.kioki, settings.colors.islands[4], ShadeRgb(settings.colors.islands[4])));
